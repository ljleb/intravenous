...
namespace {
    ...
    TEST(PredictorPortContracts, StructuralConfigurationBelongsToTheNodeType)
    {
        ...
        static_assert(realtime_history(Nlms::inputs()[0]) == 7);
        static_assert(realtime_history(Nlms::outputs()[0]) == 3);
        static_assert(realtime_history(Residual::inputs()[0]) == 6);
        static_assert(realtime_history(Residual::outputs()[0]) == 5);
        static_assert(realtime_history(ResidualAr2::inputs()[0]) == 8);
        static_assert(realtime_history(ResidualAr2::outputs()[0]) == 6);
        static_assert(realtime_history(Poly::inputs()[0]) == 3);
        static_assert(realtime_history(Poly::outputs()[0]) == 1);
