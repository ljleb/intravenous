...
namespace iv {
    ...
    struct ProjectDuplicateTimelineLaneRequest { InternedString lane_id {}; };
    ...
    using ProjectDuplicateTimelineLaneRequestedEvent =
        void (*)(ProjectDuplicateTimelineLaneRequest const &, ProjectAckBuilder &);
