...
IV_SUBSCRIBE_LINKER_EVENT(
    ...
    &NodeInstances::handle_socket_rpc_create_iv_module_instance)
IV_SUBSCRIBE_LINKER_EVENT(
    socket_rpc_node_instances_bridge,
    iv_socket_rpc_delete_iv_module_instance_event,
    &NodeInstances::handle_socket_rpc_delete_iv_module_instance)
IV_SUBSCRIBE_LINKER_EVENT(
    socket_rpc_node_instances_bridge,
    iv_socket_rpc_update_iv_module_instances_event,
    &NodeInstances::handle_socket_rpc_update_iv_module_instances)
IV_SUBSCRIBE_LINKER_EVENT(
    socket_rpc_node_instances_bridge,
