...
namespace iv {
IV_DEFINE_BRIDGE(project_persistence_package_reload_bridge)

IV_SUBSCRIBE_LINKER_EVENT(
    project_persistence_package_reload_bridge,
    iv_runtime_project_override_settings_requested_event,
    &PackageReload::handle_project_override_settings);
IV_SUBSCRIBE_LINKER_EVENT(
    project_persistence_package_reload_bridge,
    iv_runtime_project_persistence_collect_state_event,
    &PackageReload::handle_project_persistence_collect_state);
} // namespace iv
