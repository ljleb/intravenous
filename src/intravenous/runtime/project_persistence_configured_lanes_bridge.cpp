...
namespace iv {
IV_DEFINE_BRIDGE(project_persistence_configured_lanes_bridge)

IV_SUBSCRIBE_LINKER_EVENT(
    project_persistence_configured_lanes_bridge,
    iv_runtime_project_get_timeline_lane_types_requested_event,
    &ConfiguredLanes::handle_project_get_timeline_lane_types)
IV_SUBSCRIBE_LINKER_EVENT(
    project_persistence_configured_lanes_bridge,
    iv_runtime_project_create_timeline_lane_requested_event,
    &ConfiguredLanes::handle_project_create_timeline_lane)
IV_SUBSCRIBE_LINKER_EVENT(
    project_persistence_configured_lanes_bridge,
    iv_runtime_project_delete_timeline_lane_requested_event,
    &ConfiguredLanes::handle_project_delete_timeline_lane)
IV_SUBSCRIBE_LINKER_EVENT(
    project_persistence_configured_lanes_bridge,
    iv_runtime_project_duplicate_timeline_lane_requested_event,
    &ConfiguredLanes::handle_project_duplicate_timeline_lane)
IV_SUBSCRIBE_LINKER_EVENT(
    project_persistence_configured_lanes_bridge,
    iv_runtime_project_persistence_collect_state_event,
    &ConfiguredLanes::handle_project_persistence_collect_state)
} // namespace iv
