...
namespace iv {
    ...
    public:
        ...
        {
            return std::array { realtime_sample_input({}, {}, {.history = Order - 1}) };
        }

        static constexpr auto outputs()
        {
            return std::array { realtime_sample_output({}, {}, {.history = LookAhead}) };
        }
    ...
    public:
        ...
        static constexpr auto outputs()
        {
            return std::array { realtime_sample_output({}, {}, {.history = LookAhead + ArOrder}) };
        }
    ...
    public:
        ...
        static constexpr auto outputs()
        {
            return std::array { realtime_sample_output({}, {}, {.history = LookAhead + ArOrder, .latency = 0}) };
        }
