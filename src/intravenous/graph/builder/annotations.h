...
public:
  void attach_virtual_node(GraphBuilderNodeBundles&, GraphBuilderVirtualNodes&,
                           size_t node_bundle_handle,
                           std::string_view virtual_node_id,
                           SourceInfo const* source_info = nullptr);
  void annotate_node_source_info(GraphBuilderNodeBundles&, GraphBuilderVirtualNodes&,
