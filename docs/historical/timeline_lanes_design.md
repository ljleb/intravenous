...
[indexed_dsp_nodes.md](../indexed_dsp_nodes.md). In particular, `Timeline`,
...
_Current replacement-model rule: sample/event kind and realtime/compiled
...
[indexed_dsp_nodes.md](../indexed_dsp_nodes.md) for the current contract._
