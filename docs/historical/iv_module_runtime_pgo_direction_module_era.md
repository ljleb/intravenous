# Historical Runtime PGO Direction (module-era snapshot)

> Non-normative snapshot of the earlier module-reload/task-execution integration model.
> Retained because the PGO rationale, safety constraints, and rejected/considered ownership
> boundaries are useful design history. Current PGO direction is in
> [`../iv_module_runtime_pgo_direction.md`](../iv_module_runtime_pgo_direction.md).
